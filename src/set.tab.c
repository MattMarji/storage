...
{
       9,     0,    -1,    -1,    10,    11,    -1,    11,     7,    12,
      -1,    12,    -1,    13,    14,    -1,     3,    -1,    15,    -1,
      17,    -1,    -1,    15,    16,    -1,     3,    -1,     5,    -1,
       6,    -1,     4,    -1
};
...
{
       0,    40,    40,    40,    65,    67,    71,    75,   111,   113,
     116,   118,   121,   139,   146,   152
};
#endif
...
{
  "$end", "error", "$undefined", "STRING", "INT", "NEG_INT", "POS_INT",
  "COMMA", "$accept", "commands", "$@1", "command", "column", "colname",
  "colvalue", "string_values", "string_value", "int_value", 0
};
#endif
...
{
       0,     9,    10,     0,     3,    11,    12,    13,     7,     4,
       5,     6,    14,    15,    17,    12,     3,    16
};
...
#line 76 "set.y"
	...
	strcpy(c->set_values[c->numValues],(yyvsp[(1) - (1)].sval));
	c->numValues++;
	first_col2 = 1;
	}
...
#line 122 "set.y"
	...
	strcpy(c->set_values[c->numValues], (yyvsp[(1) - (1)].sval));
		...
		strcat(c->set_values[c->numValues], (yyvsp[(1) - (1)].sval));
	}
