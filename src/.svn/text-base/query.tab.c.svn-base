...
{
      10,     0,    -1,    -1,    11,    12,    -1,    12,     8,    13,
      -1,    13,    -1,    14,    15,    16,    -1,     3,    -1,     4,
      -1,    17,    -1,    19,    -1,    -1,    17,    18,    -1,     3,
      -1,     6,    -1,     7,    -1,     5,    -1
};
...
{
       0,    39,    39,    39,    62,    64,    68,    72,   105,   113,
     115,   118,   120,   123,   144,   150,   156
};
#endif
...
{
  "$end", "error", "$undefined", "STRING", "OPERATOR", "INT", "NEG_INT",
  "POS_INT", "COMMA", "$accept", "commands", "$@1", "command", "predicate",
  "colname", "op", "colvalue", "string_values", "string_value",
  "int_value", 0
};
#endif
...
{
       2,     0,     0,     1,     7,     3,     5,     0,     0,     8,
      11,     4,    16,    14,    15,     6,     9,    10,    13,    12
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     2,     5,     6,     7,    10,    15,    16,    19,
      17
};
...
{
       0,    10,    11,     0,     3,    12,    13,    14,     8,     4,
      15,    13,     5,     6,     7,    16,    17,    19,     3,    18
};
...
#line 73 "query.y"
	...
	strcpy(c->predicates[c->totPredicates], (yyvsp[(1) - (1)].sval));
	c->totPredicates++;
	first_col = 1;
	}
...
#line 124 "query.y"
	...
	//else, We must concatenate the parts!
		...
		strcat(c->predicates[c->totPredicates], (yyvsp[(1) - (1)].sval));
	}
